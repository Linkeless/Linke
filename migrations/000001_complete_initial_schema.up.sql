-- ==============================================================================
-- COMPREHENSIVE DATABASE SCHEMA - CONSOLIDATED MIGRATION
-- ==============================================================================
-- This migration consolidates all database schema requirements following MySQL best practices:
-- - Optimized indexing strategies (composite, covering indexes)
-- - Native MySQL data types and constraints
-- - Performance-optimized table structures
-- - Proper foreign key relationships at application level
