...
// Basic binding request structures
...
// Basic binding response structures
...
// Analytics and statistics structures
...
type TrendAnalysis struct {
	...
	MonthlyGrowth  []BindingMonthlyGrowthTrend `json:"monthly_growth"`
	ProviderTrends []BindingProviderTrendData  `json:"provider_trends"`
}
...
// BindingMonthlyGrowthTrend represents monthly binding growth data
type BindingMonthlyGrowthTrend struct {
	Month       string  `json:"month"`
	NewBindings int64   `json:"new_bindings"`
	GrowthRate  float64 `json:"growth_rate"`
}

// BindingProviderTrendData represents provider-specific binding trend data
type BindingProviderTrendData struct {
	Provider   string  `json:"provider"`
...
// Enhanced request structures for admin operations

// AdminBindingListRequest represents admin request for listing bindings
type AdminBindingListRequest struct {
...
// AdminBindingSearchRequest represents admin search request for bindings
type AdminBindingSearchRequest struct {
	Query         string `form:"query" json:"query"`
	Provider      string `form:"provider" json:"provider"`
	UserEmail     string `form:"user_email" json:"user_email"`
	ProviderEmail string `form:"provider_email" json:"provider_email"`
	IsPrimary     *bool  `form:"is_primary" json:"is_primary"`
...
// Security operation structures

// SecurityEventRequest represents request for creating security events
...
// SecurityEventResponse represents security event data for API responses
...
// ResolveSecurityEventRequest represents request for resolving security events
