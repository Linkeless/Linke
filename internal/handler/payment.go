...
// @Success 201 {object} response.StandardResponse{data=model.PaymentRecordResponse}
...
func (h *PaymentHandler) CreatePaymentOrder(c *gin.Context) {
	...
	paymentReq := &service.CreatePaymentOrderRequest{
		UserID:              user.ID,
...
// @Success 200 {object} response.StandardResponse{data=model.PaymentRecordResponse}
// @Failure 400 {object} response.BadRequestResponse
// @Failure 401 {object} response.UnauthorizedResponse
...
// @Success 200 {object} response.PaginatedResponse{data=[]model.PaymentRecordResponse}
// @Failure 401 {object} response.UnauthorizedResponse
// @Failure 500 {object} response.InternalServerErrorResponse
...
func (h *PaymentHandler) GetMyPaymentOrders(c *gin.Context) {
	...
	var recordResponses []*model.PaymentRecordResponse
...
// @Success 200 {object} response.StandardResponse{data=[]model.PaymentConfigResponse}
// @Failure 500 {object} response.InternalServerErrorResponse
...
func (h *PaymentHandler) GetActivePaymentConfigs(c *gin.Context) {
	...
	var configResponses []*model.PaymentConfigResponse
...
func (h *PaymentHandler) PaymentNotify(c *gin.Context) {
	...
	validGateways := []string{model.PaymentGatewayEpay, model.PaymentGatewayEPUSDT}
	...
	case model.PaymentGatewayEPUSDT:
...
// @Produce json
// @Security BearerAuth
// @Param config body service.CreatePaymentConfigRequest true "Payment config data"
// @Success 201 {object} response.StandardResponse{data=model.PaymentConfigResponse}
// @Failure 400 {object} response.BadRequestResponse
// @Failure 401 {object} response.UnauthorizedResponse
// @Failure 403 {object} response.ForbiddenResponse
// @Failure 500 {object} response.InternalServerErrorResponse
...
func (h *PaymentHandler) CreatePaymentConfig(c *gin.Context) {
	...
	// Bind request
	var req service.CreatePaymentConfigRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		response.BadRequest(c, "Invalid request data", err.Error())
		return
	}
...
// @Param limit query int false "Limit results" minimum(1) maximum(100) example(10)
// @Param offset query int false "Offset results" minimum(0) example(0)
// @Success 200 {object} response.PaginatedResponse{data=[]model.PaymentConfigResponse}
// @Failure 400 {object} response.BadRequestResponse
// @Failure 401 {object} response.UnauthorizedResponse
// @Failure 403 {object} response.ForbiddenResponse
// @Failure 500 {object} response.InternalServerErrorResponse
...
func (h *PaymentHandler) GetPaymentConfigs(c *gin.Context) {
	...
	var req service.GetPaymentConfigsRequest
...
// @Param config body service.UpdatePaymentConfigRequest true "Updated payment config data"
// @Success 200 {object} response.StandardResponse{data=model.PaymentConfigResponse}
// @Failure 400 {object} response.BadRequestResponse
// @Failure 401 {object} response.UnauthorizedResponse
// @Failure 403 {object} response.ForbiddenResponse
