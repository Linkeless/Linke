...
func (s *TicketMessageService) CreateTicketMessage(ctx context.Context, ticketID uint, userID uint, req *CreateTicketMessageRequest) (*model.TicketMessage, error) {
	...
	message := &model.TicketMessage{
		...
		Attachments: stringToPtr(req.Attachments),
...
func (s *TicketMessageService) GetTicketMessage(ctx context.Context, messageID uint) (*model.TicketMessage, error) {
...
func (s *TicketMessageService) GetTicketMessages(ctx context.Context, req *GetTicketMessagesRequest) ([]*model.TicketMessage, int64, error) {
	query := s.db.WithContext(ctx).Model(&model.TicketMessage{}).
		Preload("User").
...
func (s *TicketMessageService) UpdateTicketMessage(ctx context.Context, messageID uint, req *UpdateTicketMessageRequest) (*model.TicketMessage, error) {
...
func (s *TicketMessageService) GetTicketMessagesForUser(ctx context.Context, ticketID uint, userID uint, limit int, offset int) ([]*model.TicketMessage, int64, error) {
