...
func NewServerGroupService(db *repository.Database) *ServerGroupService {
...
func (s *ServerGroupService) CreateServerGroup(ctx context.Context, req *CreateServerGroupRequest) (*model.ServerGroup, error) {
	// Check if server group with the same name already exists
	var existingGroup model.ServerGroup
...
func (s *ServerGroupService) GetServerGroup(ctx context.Context, id uint) (*model.ServerGroup, error) {
...
func (s *ServerGroupService) GetServerGroups(ctx context.Context, req *GetServerGroupsRequest) ([]*model.ServerGroup, int64, error) {
	var groups []*model.ServerGroup
	var total int64

	query := s.db.DB.WithContext(ctx).Model(&model.ServerGroup{})
...
func (s *ServerGroupService) UpdateServerGroup(ctx context.Context, id uint, req *UpdateServerGroupRequest) (*model.ServerGroup, error) {
	// Get existing group
...
func (s *ServerGroupService) GetAllServerGroups(ctx context.Context) ([]*model.ServerGroup, error) {
	var groups []*model.ServerGroup
