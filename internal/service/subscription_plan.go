...
func (s *SubscriptionPlanService) CreateSubscriptionPlan(ctx context.Context, creatorID uint, req *CreateSubscriptionPlanRequest) (*model.SubscriptionPlan, error) {
...
func (s *SubscriptionPlanService) GetSubscriptionPlan(ctx context.Context, planID uint) (*model.SubscriptionPlan, error) {
...
func (s *SubscriptionPlanService) GetSubscriptionPlanByCode(ctx context.Context, code string) (*model.SubscriptionPlan, error) {
	var plan model.SubscriptionPlan
...
func (s *SubscriptionPlanService) GetSubscriptionPlans(ctx context.Context, req *GetSubscriptionPlansRequest) ([]*model.SubscriptionPlan, int64, error) {
	query := s.db.WithContext(ctx).Model(&model.SubscriptionPlan{})
...
func (s *SubscriptionPlanService) GetPublicSubscriptionPlans(ctx context.Context, currency string) ([]*model.SubscriptionPlan, error) {
	query := s.db.WithContext(ctx).Model(&model.SubscriptionPlan{}).
		Where("status = ? AND is_visible = ?", model.SubscriptionPlanStatusActive, true)
...
func (s *SubscriptionPlanService) UpdateSubscriptionPlan(ctx context.Context, planID uint, req *UpdateSubscriptionPlanRequest) (*model.SubscriptionPlan, error) {
	// Get existing plan
...
func (s *SubscriptionPlanService) DeleteSubscriptionPlan(ctx context.Context, planID uint) error {
	...
	if err := s.db.WithContext(ctx).Model(&model.UserSubscription{}).
		Where("subscription_plan_id = ? AND status = ?", planID, model.UserSubscriptionStatusActive).
