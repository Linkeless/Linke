...
func NewShadowsocksServerService(db *repository.Database) *ShadowsocksServerService {
...
func (s *ShadowsocksServerService) CreateShadowsocksServer(ctx context.Context, req *CreateShadowsocksServerRequest) (*model.ShadowsocksServer, error) {
	// Set default values
	if req.Rate == 0 {
		req.Rate = 1.0
	}
	...
	server := &model.ShadowsocksServer{
		GroupID:      req.GroupID,
		RouteID:      req.RouteID,
...
func (s *ShadowsocksServerService) GetShadowsocksServerByID(ctx context.Context, id int) (*model.ShadowsocksServer, error) {
...
func (s *ShadowsocksServerService) GetShadowsocksServers(ctx context.Context, req *GetShadowsocksServersRequest) ([]*model.ShadowsocksServer, int64, error) {
	var servers []*model.ShadowsocksServer
	var total int64

	query := s.db.DB.WithContext(ctx).Model(&model.ShadowsocksServer{})
...
func (s *ShadowsocksServerService) GetActiveShadowsocksServers(ctx context.Context) ([]*model.ShadowsocksServer, error) {
	var servers []*model.ShadowsocksServer
...
func (s *ShadowsocksServerService) GetShadowsocksServersByGroupID(ctx context.Context, groupID uint) ([]*model.ShadowsocksServer, error) {
	var servers []*model.ShadowsocksServer
	if err := s.db.DB.WithContext(ctx).
...
func (s *ShadowsocksServerService) UpdateShadowsocksServer(ctx context.Context, id int, req *UpdateShadowsocksServerRequest) (*model.ShadowsocksServer, error) {
	var server model.ShadowsocksServer
	if err := s.db.DB.WithContext(ctx).First(&server, id).Error; err != nil {
		if err == gorm.ErrRecordNotFound {
			return nil, fmt.Errorf("shadowsocks server not found")
...
func (s *ShadowsocksServerService) DeleteShadowsocksServer(ctx context.Context, id int) error {
	result := s.db.DB.WithContext(ctx).Delete(&model.ShadowsocksServer{}, id)
	if result.Error != nil {
