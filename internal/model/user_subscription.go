...
type UserSubscription struct {
	...
	// Relationships (foreign key associations for GORM preloading)
	User             *User             `json:"user,omitempty" gorm:"foreignKey:UserID;references:ID"`
	SubscriptionPlan *SubscriptionPlan `json:"subscription_plan,omitempty" gorm:"foreignKey:SubscriptionPlanID;references:ID"`
...
func (us *UserSubscription) ToResponse() *UserSubscriptionResponse {
	...
	if us.SubscriptionPlan != nil {
		resp.SubscriptionPlan = us.SubscriptionPlan.ToResponse()
	}
