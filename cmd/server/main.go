...
func NewHTTPServer(
	...
	// 管理员路由组 (/api/v1/admin) - 需要认证和管理员权限
	...
	// 管理员订阅路由 (/api/v1/admin/subscriptions)
	...
	// 订阅路由 (/api/v1/subscription) - 大部分需要认证
	...
	// 订阅订单路由复数形式 (/api/v1/subscription-orders)
	...
	// 支付路由复数形式 (/api/v1/payments) - 提供常见的复数形式API路径
	...
	// 支付方式管理路由 (/api/v1/payment-methods) - 需要认证
